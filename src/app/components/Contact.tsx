...
const Contact = () => {
    return (
      <section id="contact" className="max-w-7xl mx-auto px-6 sm:px-10 md:px-20 py-16 sm:py-24 space-y-6 text-center">
        <h1 className="text-2xl sm:text-3xl font-bold">Let's help your business thrive</h1>
        <p className="text-sm sm:text-base">Send us your email and we will get back to you</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center text-sm sm:text-base mt-10">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="mailto:shalops.digitals@gmail.com">shalops.digitals@gmail.com</a>
          </div>
          <div className="flex items-center gap-2">
            <FaMapMarker className="w-4 h-4" />
            <a href="https://goo.gl/maps/1234567890">4 Kilo, Addis Ababa, Ethiopia</a>
          </div>
        </div>
      </section>
    );
