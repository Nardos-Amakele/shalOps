        ...
        >
          ...
          >
            ...
            <span className="hidden md:inline">
              {" "}
              By understanding your challenges, we build technology that
              streamlines operations, boosts growth, and drives success.
            </span>
          </motion.p>
          ...
          >
            {submitStatus ? (
              <div
                className={`px-4 py-3 rounded-lg w-full text-center ${
              ...
              <>
                ...
                <motion.button
                  ...
                  className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-[#8C52FF] to-[#160E23] text-white font-semibold rounded-lg shadow-md hover:opacity-90 disabled:opacity-90 transition-all z-50 duration-200"
                >
                  {isSubmitting ? (
